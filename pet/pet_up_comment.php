...
<main>
    ...
    <form action="pet_up_comment_check.php" method="POST">
      ...
      <div class="m-auto" style="width: 80%;">
        <p class="m-0">お悩み相談</p>
        <textarea name="request" rows="8" cols="36" placeholder="飼育方法や、健康状態で気になる事があればこちらに入力してください。３営業日以内にお返事させて頂きます。お返事は過去の投稿写真をタップするとご覧頂けます。"></textarea>
      </div>
      <div class="text-center my-4">
        <button class="m-auto btn btn-primary text-white w-50" type="submit">確認</button>
      </div>
