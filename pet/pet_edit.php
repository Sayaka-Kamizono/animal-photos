...
<div style="height: 80px;">
  ...
  <!-- ヘッダーend -->
    ...
    <main>
      ...
      <p class="text-danger text-center">※変更できるのはアイコン画像と名前のみです。これ以外を変更する場合は「お問い合わせ」から申請してください。</p>
      <!-- 入力フォーム -->
      <form action="pet_update.php" method="POST" enctype="multipart/form-data">
        <div class="text-center">
          <input type="file" name="upfile" accept="image/*"capture="camera" onchange="previewImage(this)";>
          <p class="m-0">--preview--</p>
          <div class="bg-white w-50 mx-auto my-2">
            <img id="preview" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" style="max-width:200px;" class="" style="height: 150px;">
          </div>
